...
$GLOBALS['TL_DCA']['tl_article']['fields']['containerClass'] = [
    ...
    'default'   => 'main',
    'inputType' => 'select',
    'options'   => System::getContainer()->getParameter('markocupic_article_class_select_bundle.container_class'),
...
$GLOBALS['TL_DCA']['tl_article']['fields']['backgroundClass'] = [
    ...
    'default'   => 'main',
    'inputType' => 'select',
    'options'   => System::getContainer()->getParameter('markocupic_article_class_select_bundle.background_class'),
